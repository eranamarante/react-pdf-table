...
var TableRow = (function (_super) {
  ...
  TableRow.prototype.render = function () {
    ...
    var weightingsPerNotSpecified = Math.ceil(
    ...
    return React.createElement(
      ...
      {
        style: {
          borderBottom: includeBottomBorder === true ? "1pt dashed black" : 0,
          borderRight: includeRightBorder === true ? "1pt dashed black" : 0,
          borderLeft: includeLeftBorder === true ? "1pt dashed black" : 0,
          borderTop: includeTopBorder === true ? "1pt dashed black" : 0,
          width: "100%",
          display: "flex",
          flexDirection: "row",
      ...
      rowCells.map(function (rc, columnIndex) {
        ...
        return React.cloneElement(rc, {
          weighting:
            (_a = rc.props.weighting) !== null && _a !== void 0
              ? _a
              : weightingsPerNotSpecified,
