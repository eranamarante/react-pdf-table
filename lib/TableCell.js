...
var TableCell = (function (_super) {
  ...
  TableCell.prototype.render = function () {
    ...
    var defaultStyle = {
      ...
      textAlign:
        (_b = this.props.textAlign) !== null && _b !== void 0 ? _b : "left",
      fontSize:
        (_c = this.props.fontSize) !== null && _c !== void 0
          ? _c
    ...
    var mergedStyles = __spreadArray(
      [defaultStyle],
      (0, Utils_1.transformToArray)(this.props.style),
      true
    );
    return React.createElement(
      renderer_1.View,
      { style: mergedStyles, wrap: true },
      content
    );
  };
  return TableCell;
